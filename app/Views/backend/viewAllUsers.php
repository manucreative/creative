              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="user-listing" class="table table-bordered table-striped">
                  ...
                  <tbody>
                            <tr data-href="<?php echo base_url('creative/admin/updateUserForm/index/key/' . $session_key . '/' . $admin['adminToken']); ?>">
                              ...
                              <td><button class="btn btn-sm" style="color: #fff; font-size: 18px; background-color:<?php echo $admin['activation_name'] === 'active'? 'blue;': 'red;'?>" ><?php echo $admin['activation_name'];?></button></td>
                              <td><a class="btn btn-primary" href="<?php  echo base_url('creative/admin/updateUserForm/index/key/'.$session_key.'/'.$admin['adminToken']);?>"><i class="fa fa-edit"></i>&nbsp; Edit</a></td>
                            </tr>
                      </tbody>
                      <?php endforeach?>
                      <?php endif ?>
